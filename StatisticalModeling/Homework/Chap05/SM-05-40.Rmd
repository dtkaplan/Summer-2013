...
```{r include=FALSE,eval=FALSE}
I(textItem(name="closerToValue", totalPts=2, rows=1))
```
For this simulation of heights, the population
standard deviation was set to 3.  
You expect the result from a random sample to be close to the
population parameter.   Which of the two sample sizes, $n=10$ or
$n=1000$ gives results that are closer to the population value? 
