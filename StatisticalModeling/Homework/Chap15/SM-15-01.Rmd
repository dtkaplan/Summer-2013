...
```{r include=FALSE}
prob1=selectSet(name="pointEstimate", totalPts=1, "Girls' feet are, on average, 25 centimeters long."=FALSE, "Girls'feet are 0.4079 cm shorter than boys'."=FALSE, "Girls' feet are 0.7839 cm shorter than boys'."=TRUE, "Girls' feet are 1.922 cm shorter than boys'."=FALSE)
```
...
```{r include=FALSE}
prob2=selectNumber(choices=c(-0.78,0.28,0.41,0.60,0.80), correct=c(0.80), totalPts=1, name="95percentM")
```
...
```{r include=FALSE}
prob3=selectSet(name="NullHypothesis", totalPts=1, "Boys' feet are, on average, longer than girls' feet."=FALSE, "Girls' feet are, on average,  shorter than boys' feet."=FALSE, "All boys' feet are longer than all girls' feet."=FALSE, "No girl's foot is shorter than all boys' feet."=FALSE, "There is no difference, on average, between boys' footlengths
  and girls' footlengths."=TRUE)
```
...
```{r include=FALSE}
prob4=selectSet(name="NullHypothesis2", totalPts=1, "Boys' and girls' feet are, on average, the same length."=FALSE, "The length of kids' feet is, on average, zero."=FALSE, "The length of boys' feet is, on average, zero."=TRUE, "The length of girls' feet is, on average, zero."=FALSE, "Girls' and boys' feet don't intercept."=FALSE)
```
...
```{r include=FALSE}
prob5=selectSet(name="NullHypothesis3", totalPts=1, "Girls' feet have a different length, on average, than boys'."=FALSE, "Girls' feet are no different in length, on average, than boys'."=FALSE, "Girls' footlengths are, on average, zero."=TRUE, "Girls' footlengths are, on average, greater than zero."=FALSE)
```
What is the Null Hypothesis tested by the p-value on <code>sexG</code>? `r I(prob5)`
