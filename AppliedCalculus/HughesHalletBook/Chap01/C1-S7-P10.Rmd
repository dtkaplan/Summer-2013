...
require(mosaic)
require(ScoreR)
startProblem("AC-1-7-10-SD")
```

According to the formula given in the book, $$N(t) = N_0 e^{t/500}$$
```{r include=FALSE}
prob1=selectSet(name="doubling.time", totalPts=1, "250 days"=FALSE, "309 days"=FALSE, "347 days"=TRUE, "382 days"=FALSE, "460 days"=FALSE, "500 days"=FALSE)
```
