...
```{r include=FALSE}
prob1=selectSet(name="supportConclusion", totalPts=1, "There are 4 degrees of freedom in the residual."=FALSE, "The p-value is very small."=FALSE, "The p-value is not small."=TRUE, "There is no p-value on the residuals."=FALSE)
```
...
```{r include=FALSE}
prob2=selectSet(name="nullHypothesis", totalPts=1, "The Tea and Paracetamol have the same effect."=TRUE, "The Tea is more effective than Paracetamol."=FALSE, "The Tea is less effective than Paracetamol."=FALSE)
```
...
```{r include=FALSE}
prob3=selectNumber(choices=c(12,75,150,500,2000), correct=c(500), totalPts=1, name="NumberOfCases")
```
