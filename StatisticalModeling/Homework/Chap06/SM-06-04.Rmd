...
<aside>
ANSWER:     
```{r fig-4-3-q1,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
m = lm( D ~ A+G, data=df)
h = coef(m)
...
<aside>
ANSWER:     
```{r fig-4-3-q2,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
m = lm( D ~ A*G, data=df)
h = coef(m)
...
<aside>
ANSWER:     
```{r fig-4-3-q3,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
m = lm( D ~ A-1, data=df)
h = coef(m)
...
<aside>
ANSWER:     
```{r fig-4-3-q4,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
m = lm( D ~ 1, data=df)
h = coef(m)
...
<aside>
ANSWER:     
```{r fig-4-3-q5,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
m = lm( D ~ A, data=df)
h = coef(m)
...
<aside>
ANSWER:     
```{r fig-4-3-q6,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
...
# Is the above statement necessary?
  
  
Example: *D ~ G*

```{r fig-4-3-ex1,fig=TRUE,pdf=TRUE,include=TRUE,figwidth=3,figheight=3,echo=FALSE}
basic.plot()
