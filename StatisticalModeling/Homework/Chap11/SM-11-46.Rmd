...
I(textItem(name="3percent", totalPts=2, rows=3))
```
...
```{r include=FALSE,eval=FALSE}
I(textItem(name="15percent", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="meanGroupB", totalPts=2, rows=3))
```
