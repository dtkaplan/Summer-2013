Intro to Statistical Modeling Ch.1 Prob 1.06
========================================================
```{r include=FALSE}
require(mosaic)
require(WriteScoreR)
newScorerSet("SM-01-AC1-06-SD")
```
...
I(textItem(name="integers1to10", rows=3, totalPts=2))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="integers5to15", rows=3, totalPts=2))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="oddintegers", rows=3, totalPts=2))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="evenlyspaced", rows=3, totalPts=2))
```
