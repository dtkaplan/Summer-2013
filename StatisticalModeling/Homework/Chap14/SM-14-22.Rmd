...
Copy the table onto a piece of paper and enter your results in the empty second and third columns to hand into your professor.  
...
I(textItem(name="p=38", totalPts=2, rows=3))
```
