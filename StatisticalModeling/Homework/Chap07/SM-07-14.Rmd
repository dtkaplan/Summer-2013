...
```{r include=FALSE}
run2=selectSet(name="age", totalPts=1, "Negative"=TRUE, "Zero"=FALSE, "Positive"=FALSE)
```
* What will be the sign of the coefficient on *sex*?  (Assume that the *sex* variable is an indicator for women.) `r I(run2)`

```{r include=FALSE}
run3=selectSet(name="age", totalPts=1, "Negative"=FALSE, "Zero"=FALSE, "Positive"=TRUE, "There is no interaction coefficient"=FALSE, "No way to tell, even roughly, from the information given"=FALSE)
```
