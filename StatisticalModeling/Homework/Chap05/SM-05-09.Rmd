Intro to Statistical Modeling Ch. 5 Prob. 9
========================================================
```{r include=FALSE}
require(mosaic)
require(WriteScoreR)
newScorerSet("SM-05-09-SD")
```
...
I(textItem(name="confidenceInterval", totalPts=2, rows=5))
```

`r I(textItem(name="confidenceInterval", totalPts=2, rows=5))`
