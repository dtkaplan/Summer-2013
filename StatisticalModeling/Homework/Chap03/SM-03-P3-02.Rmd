Intro to Statistical Modeling Ch. 3 Prob. 3.02
========================================================
```{r include=FALSE}
require(mosaic)
require(WriteScoreR)
newScorerSet("SM-3-P2-SD")
```
...
```{r include=FALSE}
irisquest4=selectNumber(choices=c(1.2,3.6,4.2,4.7,5.9), correct=c(4.7), name="SepalLenght", totalPts=1)
```
...
```{r include=FALSE}
carsq=selectSet(name="name", totalPts=1, "carb"=TRUE, "color"=FALSE, "size"=FALSE, "weight"=FALSE, "wheels"=FALSE)
```
