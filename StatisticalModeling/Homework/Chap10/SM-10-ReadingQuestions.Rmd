...
```{r include=FALSE, eval=FALSE}
I(textItem(name="partial", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="experiment", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="modeling", totalPts=2, rows=3))
```
