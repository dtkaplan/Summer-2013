Intro to Statistical Modeling Ch. 3 Prob 3.36
========================================================
```{r include=FALSE}
require(mosaic)
require(WriteScoreR)
newScorerSet("SM-3-P36-SD")
```
...
can read your data.  Make sure to **paste the link** into the
textbox so that your data can be accessed.

Please don't inconvenience other elevator users with the experiment.

```{r include=FALSE, eval=FALSE}
I(textItem(name="elevator", totalPts=5, rows=3))
```

`r I(textItem(name="elevator", totalPts=5, rows=3))`
