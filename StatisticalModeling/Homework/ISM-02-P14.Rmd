...
```{r include=FALSE}
codebook=selectSet(totalPts=1, name="gest", "categorical"=FALSE, "ordinal"=FALSE, "quantitative"=FALSE)
```
...
```{r include=FALSE}
codebook2=selectSet(totalPts=1, name="race", "categorical"=TRUE, "ordinal"=FALSE, "quantitative"=FALSE)
```
...
```{r include=FALSE}
codebook3=selectSet(totalPts=1, name="marital", "categorical"=TRUE, "ordinal"=FALSE, "quantitative"=FALSE)
```
...
```{r include=FALSE}
codebook4=selectSet(totalPts=1, name="income", "categorical"=FALSE, "ordinal"=TRUE, "quantitative"=FALSE)
```
...
```{r include=FALSE}
codebook5=selectSet(totalPts=1, name="smoke", "categorical"=TRUE, "ordinal"=FALSE, "quantitative"=FALSE)
```
...
```{r include=FALSE}
codebook6=selectSet(totalPts=1, name="number", "categorical"=FALSE, "ordinal"=TRUE, "quantitative"=FALSE)
```
