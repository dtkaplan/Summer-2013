...
I(textItem(name="betterModel", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="compost", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="redundant", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="estimate", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="perfect", totalPts=2, rows=1))
```
