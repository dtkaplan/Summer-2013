...
```{r include=FALSE}
require(WriteScoreR)
newScorerSet("Ch2-prob02-DTK-2013-05-27")
require(mosaic)
```
...
* Transmission type `r I(selectSet(name="trans2",totalPts=1,"A level of a categorical variable"=FALSE,"A categorical variable"=TRUE,"A quantitative variable"=FALSE))`
* Number of cylinders `r I(selectSet(name="cylinders2",totalPts=1,"A level of a categorical variable"=FALSE,"A categorical variable"=FALSE,"A quantitative variable"=TRUE))`
