...
```{r fig1, fig=TRUE,include=FALSE,pdf=TRUE,figwidth=6,figheight=6,echo=FALSE}
d = fetchData("inflation.csv")
decade = cut( d$Year, c(1968,1984,1995,2001)) 
plot( Inflation ~ Unemployment, data=d, pch=as.numeric(decade), xlab='Unemployment (%)', ylab='Inflation (%)')
legend( list(x=9,y=12), c('Decade A', 'Decade B', 'Decade C'),pch=1:3)
```

![Inflation](inflation-fig1.png)
\centerline{\includegraphics[width=3.5in]{Figures/inflation-fig1}}
