...
```{r include=FALSE, eval=FALSE}
I(textItem(name="model.term.V.variable", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="multiple.model.terms", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="interaction.term", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="slopes.v.steps", totalPts=2, rows=3))
```
...
```{r include=FALSE, eval=FALSE}
I(textItem(name="casual.connections", totalPts=2, rows=3))
```
 `r I(textItem(name="casual.connections", totalPts=2, rows=3))`
